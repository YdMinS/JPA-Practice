package com.ydmins.JPA_SHOP.repository.order.query;
...
public class OrderQueryRepository {
    ...
    private Map<Long, List<OrderItemQueryDto>> getOrderItemMap(List<Long> orderIds) {
        List<OrderItemQueryDto> orderItems =  em.createQuery(
                "select new com.ydmins.JPA_SHOP.repository.order.query.OrderItemQueryDto(oi.order.id, i.name, " +
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery(
                "select new com.ydmins.JPA_SHOP.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, " +
                        " o.status, d.address) " +
                        " from Order o " +
                        "join o.member m " +
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery(
                "select new com.ydmins.JPA_SHOP.repository.order.query.OrderFlatDto(o.id, m.name, o.orderDate, o" +
